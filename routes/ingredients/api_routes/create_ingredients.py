...
def create_ingredient():
    ...
    try:
        ...
        def validate_ingredient(data):
            ...
            if not reference_unit or not isinstance(reference_unit, str) or len(reference_unit) > 10:
                return f"Invalid reference_unit: ({reference_unit}) must be a non-empty string ≤ 10 chars"
            ...
            if not cup_equivalent_weight or not isinstance(cup_equivalent_weight, (int,float)) or not(0< cup_equivalent_weight < 10000):
            ...
            if not cup_equivalent_unit or not isinstance(cup_equivalent_unit, str) or len(cup_equivalent_unit) > 10:
                return f"Invalid cup_equivalent_unit: ({cup_equivalent_unit}) must be a non-empty string ≤ 10 chars"
       ...
       # Validate user_id exists & user has the privilege to delete the ingredient
        ...
        print("validated user id and role")
